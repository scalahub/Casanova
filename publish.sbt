...
ThisBuild / scmInfo := Some(
  ScmInfo(
    url("https://github.com/scalahub/Casanova"),
    "scm:git@github.scalahub/Casanova.git"
  )
)
...
ThisBuild / description := "A Cassandra query library for Scala"
ThisBuild / licenses := List(
  "The Unlicense" -> new URL("https://unlicense.org/")
)
ThisBuild / homepage := Some(url("https://github.com/scalahub/Casanova"))
